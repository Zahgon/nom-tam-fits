...
public enum Synonyms {
     ...
     */
    EXPOSURE(ObservationDurationDescription.EXPOSURE, ObservationDurationDescription.EXPTIME, ObservationDurationDescription.ONTIME, STScIExt.XPOSURE),
    /**
     ...
     * @since 1.20.1
     */
    // MaxImDLExt.AOCWIND, uses different units
    WINDSPD(CommonExt.WINDSPD, MaxImDLExt.BOLTWIND, MaxImDLExt.DAVWIND),
    /**
